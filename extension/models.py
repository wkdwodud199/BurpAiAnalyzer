...
class CVEEntry:
    ...
    def __init__(self, cve_id, cvss, severity, description, affected_versions,
                 poc_code=None, poc_usage=None, verification_status=None):
        self.cve_id = cve_id
        self.cvss = cvss
        ...
        self.verification_status = verification_status or "UNVERIFIED"

    def __repr__(self):
        return "CVEEntry(%s [%s] %s %s)" % (self.cve_id, self.severity, self.cvss, self.verification_status)
